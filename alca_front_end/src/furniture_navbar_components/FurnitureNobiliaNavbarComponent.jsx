...
export default function FurnitureNobiliaNavbarComponent() {
  ...
  return (
    ...
    <div className='flex w-full justify-between items-center h-20 px-4 absolute z-10 text-white'>
        ...
        {/* Nobilia Navbar első elem, a főoldal menüpont  */}
        ...
        <div onClick={handleNav} className={nav ? 'absolute text-black left-0 top-0 w-full bg-gray-200/90 px-14 py-10 flex flex-col' : 'absolute left-[-100%]'}>
            <ul>
                <h1>Alca Kft.</h1>  
                <li className='border-b'>Nobilia Bútor Specifikácíó Teszt 1</li>
                <li className='border-b'>Nobilia Bútor Specifikácíó Teszt 2</li>
                <li className='border-b'>Nobilia Bútor Specifikácíó Teszt 3</li>
                <li className='border-b'>Nobilia Bútor Specifikácíó Teszt 4</li>
                <li className='border-b'>Nobilia Bútor Specifikácíó Teszt 5</li>
