...
const KitchenAccessorysMainMosogatoszerAdagolokComponent = ({ id }) => {

  useEffect(() => {
    if (id === 'mosogatoszeradagolo') {
  ...
  return (
    ...
    <div className='flex flex-col h-full justify-center'>
      <h3 className='text-5xl md:text-6xl font-bold'>Mosogatószer adagoló választék</h3>
...
export default KitchenAccessorysMainMosogatoszerAdagolokComponent
