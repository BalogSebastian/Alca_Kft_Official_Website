...
const KitchenAccessorysMainViztisztitokComponent = ({ id }) => {
  ...
  <div className='flex flex-col h-full justify-center ml-40'>
      <h3 className='text-5xl md:text-6xl font-bold'>Víztisztítók</h3>
      <p className='text-2xl py-6'>
        Bronz, arany gránit Víztisztítók..
      </p>
      <p className='pb-6'>
        Kis és nagy méretű
      </p>
...
export default KitchenAccessorysMainViztisztitokComponent
