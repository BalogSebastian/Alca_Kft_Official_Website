...
const KitchenAccessorysMainBeepitettSzemmettarolokComponent = ({ id }) => {

  useEffect(() => {
    if (id === 'beepitettszemettarolo') {
  ...
  return (
    ...
    <div className='flex flex-col h-full justify-center'>
      <h3 className='text-5xl md:text-6xl font-bold'>Beépített szemméttárolók választék</h3>
      <p className='text-2xl py-6'>
        45 cm, 60 cm es hulladéktárolók
      </p>
      <p className='pb-6'>
        Ket , három tartományos
      </p>
      <div>
...
export default KitchenAccessorysMainBeepitettSzemmettarolokComponent
